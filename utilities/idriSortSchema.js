...
exports.idriSortSchema = idriSortSchema;
...
function groupByTypeAndSortByName(array) {
  ...
  array.forEach(function (item) {
    ...
    } else if ((0, _definition.isInterfaceType)(item)) {
      arrayInterface.push(item);
    } else if ((0, _definition.isUnionType)(item)) {
      arrayUnion.push(item);
    } else if ((0, _definition.isEnumType)(item)) {
      arrayEnum.push(item);
    } else if ((0, _definition.isInputObjectType)(item)) {
